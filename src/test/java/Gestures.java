...
public class Gestures {
    ...
    public void setup() throws MalformedURLException {
        ...
        desiredCapabilities.setCapability("deviceName", "Pixel 2 Android Studio");
...
AndroidElement customAdapter = driver.findElement(By.xpath("//android.widget.TextView[@content-desc='1. Custom Adapter']"));
touchAction.tap(TapOptions.tapOptions().withElement(ElementOption.element(customAdapter))).perform();
AndroidElement peopleNames = driver.findElementByXPath("//*[@text='People Names']");
touchAction.longPress(LongPressOptions.longPressOptions().withDuration(Duration.ofSeconds(2)).withElement(
        ElementOption.element(peopleNames))).perform();
