...
public class ApiDemosStepDefs {
    ...
    public void i_long_press_on_dog_names_button_for_seconds(Integer seconds) {
        CustomAdapterPage customAdapterPage =new CustomAdapterPage(driver);
        TouchAction touchAction = new TouchAction(driver);
        touchAction.longPress(LongPressOptions.longPressOptions().withDuration(Duration.ofSeconds(seconds)).withElement(
                ElementOption.element(customAdapterPage.dogNames))).perform();
    }
